...
REB NOTES: 
line 104 - 109 fails to change working directory.  
...
Get rid of year-specific file names (line 77)!!!!!

load_obj() function is created in lines 61 - 65, but never used later in the script.  Remove it!
