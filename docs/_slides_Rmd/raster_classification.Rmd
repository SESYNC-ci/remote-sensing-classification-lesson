...
out_suffix <-"exercise6_03312018" # output suffix for the files and output folder
...
```{r, title = '{{ site.handouts[0] }}'}
if(is.null(out_dir)){
  out_dir <- dirname(in_dir_var) # output will be created in the input directory
}
...
if(create_out_dir_param==TRUE){
  ...
  setwd(out_dir) # use previously defined directory
}
```
...
Generate more accurate measurements from functions in the caret R package:
```{r, title = '{{ site.handouts[0] }}'}
